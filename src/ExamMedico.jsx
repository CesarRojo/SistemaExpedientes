...
function ExamenMedico() {
    ...
    const fetchAntecedentesPatologicos = async () => {
      try {
        const response = await axios.get('http://172.30.189.95:5005/antecPatolog');
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ['planta', 'fecha'];
    ...
    try {
        ...
        const examMedicoResponse = await axios.post('http://172.30.189.95:5005/examMedico', {
            examMedicoData: {
